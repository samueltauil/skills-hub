...
[![Skills Count](https://img.shields.io/badge/Skills-243-blue)](./site/src/data/skills.json)
...
|----------|:------:|-------------|
| ✨ Code Quality | 62 | Reviews, refactoring, linting |
| 📝 Documentation | 42 | READMEs, PRDs, technical writing |
| 🔀 Git & Version Control | 35 | Commits, branching, GitHub operations |
| 🎨 Frontend & UI | 28 | React, Vue, components, design |
| 🔌 API & Backend | 27 | REST APIs, GraphQL, databases |
| 🧪 Testing | 23 | Unit tests, E2E, test automation |
| 🚀 DevOps & CI/CD | 13 | Pipelines, Docker, Kubernetes |
